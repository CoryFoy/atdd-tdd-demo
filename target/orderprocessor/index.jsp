    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(".amount-entry").change(function() {
                ...
                $('.amount-entry').each(function() {
                    orderTotal += Number($(this).val().replace("$", ""));
                })

                $.getJSON("/orderprocessor/discount?total=" + orderTotal, function (data) {
                    new AutoNumeric('#discounts-display', data['totalDiscount'], {currencySymbol: '$'});
                    new AutoNumeric('#total-display', data['totalAfterDiscount'], {currencySymbol: '$'});
                });
            });
        });
    </script>
